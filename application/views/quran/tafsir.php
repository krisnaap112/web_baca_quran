 <!-- Begin Page Content -->
        <div class="main-content">
          ...
          <div class="section-header">
            <i class="fas fa-book-open"></i><h1 class="ml-3"><?= $title; ?></h1>
          </div>

          <?= $this->session->flashdata('message'); ?>

          <div class="card my-3 shadow-sm">
            <div class="card-header alert-secondary text-center">
              Cinta Quran
            </div>
            <div class="card-body alert-warning">
              <h2 class="card-title text-center">Tafsir Al Quran</h2>
              <hr>
            ...
            <div class="col-lg mt-3">
                <form action="<?= base_url('quran/tafsir'); ?>" method="post">
                  <div class="input-group mb-3">
                    <input type="text" name="keyword" class="form-control" placeholder="Cari Tafsir" autocomplete="off" autofocus="on">
          ...
          <h5 class="text-left">Hasil Pencarian : <?= $jumlah; ?></h5>
        </div>
        </div>
              ...
              <div class="card border-left-primary shadow-sm py-2">
                <div class="card-body alert-info">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h6 font-weight-bold text-danger text-uppercase mb-1"><?= $t['judul_tafsir']; ?></div>
                     <div class="text-xs mb-0 font-weight-bold text-gray-800">Penulis : <?= $t['penulis']; ?></div>
                     <a href="<?= base_url('quran/detailTafsir/') . $t['id_tafsir']; ?>" class="btn btn-sm btn-primary mt-3">Baca</a>
                    </div>
                  </div>
                </div>
              </div>

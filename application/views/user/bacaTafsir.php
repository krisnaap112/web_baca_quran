                      ...
                      <div class="col-12 col-md-12 col-lg-12">
                        <div class="card profile-widget">
                          ...
                          <?php foreach ($tafsir as $t) : ?>
                            ...
                            <div class="profile-widget-name text-center">Ditulis Pada : <?= date('d F Y', strtotime($t['tanggal_buat'])); ?></div>
                            <div class="profile-widget-name"><p><?= $t['isi_tafsir']; ?></p></div>
                            <a href="<?= base_url('user/tafsir'); ?>" class="btn btn-warning">Kembali</a>
                          <?php endforeach; ?>
                        </div>
                      </div>
                    </div>
